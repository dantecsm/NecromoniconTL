    ...
    (branch-var
     ...
     (</>
      ...
      (/
       ...
       (proc 0)
       (str "The person who used to own this book, whether it was a he or a " 'br)
       (str "she, must have loved reading it over and over again." 'br)
       (proc 0))
      (/
       (str "Looks like yet another volume from the usual complete works of " 'br)
       (str "Shakespeare." 'br)
       (str "It's not like it's got a particularly fancy binding or anything, ")
       (str "and since it's just one volume out of a complete set, it doesn't ")
       (str "seem to have any real value." 'br)
       (proc 0))
      (/
       (str "It's John Collins' theology book." 'br)
       (str "You actually have a book by some not-so-famous British " 'br)
       (str "theologian." 'br)
      ...
      (/
       ...
       (str "Come to think of it, I wonder if old man Marsh can read and " 'br)
       (str "write." 'br)
       (proc 0))
      (/
      ...
      (/
       ...
       (str "Sophocles")
       (proc 0)
       (str "『We saw the swaying noose, and the figure of a woman who had " 'br)
       (str "hanged herself.』" 'br)
       (str "Seems to be a writer from Greece, but I've never even heard the ")
       (str "name." 'br)
       (proc 0))))
    (if (</> (// (? (!= A 0)) (nop@) (proc 3))))))
 (seg*
