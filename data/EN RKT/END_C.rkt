(mes
 ...
 (seg*
  ...
  (str "　This game is a work of fiction. All characters, place names, " 'br)
  (str "organizations, etc. appearing in the game are entirely fictional ")
  (str "and have no connection whatsoever to real names." 'br)
  ((cmd 209) 1 4 0)
  (delay 1500 0)
  ((cmd 209) 0 4 0)
