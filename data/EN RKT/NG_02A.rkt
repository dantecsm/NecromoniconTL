 ...
 (seg (? (= 997 #t) (= 998 #t) (= 999 #t))
   ...
   (if (</>
        (//
         ...
         (proc 7)
         (proc 1)
         (str "I met up with Cordelia, who had refused to enter the Church and ")
         (str "waited outside." 'br)
         (proc 0)
         (str "Cordelia seemed to feel bad for not coming in with us, and " 'br)
         (str "looked uneasy." 'br)
         (proc 0)
         ...
         (str "　　　　　　No need to worry about thieves breaking into this Church, ")
         (str "that's for sure." 'br)
         (proc 0)
         (nop@)
         (set-reg 569 #f))
        (//
        ...
        (//
         ...
         (str "It's not as scary as when I saw it in the dead of night, but " 'br)
         (str "still, it doesn't feel anything like a church." 'br)
         (proc 0)
         (nop@)
         (set-reg 568 #t))))
   (proc 3)
    ...
    (branch-var
     ...
     (</>
      ...
      (/
       (if (</>
            (//
             (str "With how creepy it looks, I doubt any painter would even want to ")
             (str "pick up a brush." 'br)
             (proc 0)
             (set-reg 437 #t)
             (nop@))
            (//
             (str "Towering trees stand as if reaching up to the heavily overcast " 'br)
             (str "sky." 'br)
             (str "All the trees-firs and beeches alike-have been twisted in weird ")
             (str "ways by the strong wind, casting an unpleasant shadow over the " 'br)
             (str "landscape that looks like something out of a painting." 'br)
             (proc 0)
             (str "With how creepy this scene is, no painter would want to pick up ")
             (str "their brush." 'br)
             (proc 0)
             (nop@)
             (set-reg 437 #t)))))
      (/
       (if (</>
            (//
             ...
             (str "valuable piece of architecture." 'br)
             ...
             (str "heard of such a group. It's probably just another shady new " 'br)
             (str "religion, but I can't understand why they'd set up their base in ")
             (str "a countryside like this." 'br)
             (proc 0)
             (set-reg 438 #t)
             (nop@))
            (//
             ...
             (str "seems to me that it has a different vibe from the Church I'm " 'br)
             (str "used to." 'br)
             (proc 0)
                ...
                (branch-reg
                 ...
                 (</>
                  (/
                   ...
                   (str "　　　　　　Do you really think I'd go for the donation box in a dumpy ")
                   (str "Church like this？" 'br)
                   (proc 0)
                   ...
                   (str "　　　　　　　　If you've got something shady going on, I'd be happier " 'br)
                   (str "if you came clean about it sooner rather than later." 'br)
                   (proc 0)
                  ...
                  (/
                   ...
                   (str "　　　　　　　　There's some kind of ornament on top of the crest, it " 'br)
                   (str "might be something pretty fancy." 'br)
                   (proc 0)
                   (str "[Thomas] どれだい？")
                   (proc 0)
                   ...
                   (proc 0)
                   (str "[Thomas] What the hell... Something like that, it's not worth " 'br)
                   (str "anything." 'br)
                   (str "　　　　　　First off, it's fixed on so tight, I don't think I can " 'br)
                   (str "take it off." 'br)
                   (proc 0)
                ...
                (branch-reg
                 ...
                 (</>
                  (/
                   ...
                   (str "　　　　　　　　First off, there isn’t even a Cross standing in this " 'br)
                   (str "Church." 'br)
                   (proc 0)
                   (str "[Thomas] Isn't that just the pastor's hobby？" 'br)
                   (str "　　　　　　Isn't it fine if there's at least one dude like that " 'br)
                   (str "around?" 'br)
                   (proc 0)
                   ...
                   (str "　　　　　　Trying to understand a king who faked adultery to divorce ")
                   (str "his wife and had her executed, just for that reason." 'br)
                   (proc 0)
                   (str "[Jonathan] I feel like you might even be able to talk the " 'br)
                   (str "cardinal into allowing polygamy." 'br))
                  (/ (str "Like Gardner said, it'd be better to keep quiet about us being " 'br)
                  (str "suspicious of Thomas." 'br))))
                (nop@)
                (set-reg 439 #t))))
             (proc 0)))))
      (/
       (if (</>
            (//
             (? (= 440 #t))
             (nop@)
             (str "[Gardner] Anyway, it's best not to let your guard down around " 'br)
             (str "Thomas." 'br)
            ...
            (//
             (branch-reg
              ...
              (</>
               (/
                (str "[Gardner] Jonathan, take a good look at the crest above the " 'br)
                (str "church door. You've seen that before, haven't you！" 'br)
                (proc 0)
                ...
                (str "　　　　　　　　Does　Thomas　have　something　to　do　with　this　church　and　th")
                (str "at　Black　priest　named　Nai　I　met？" 'br)
                (proc 0)
                (str "[Gardner] Even if that were the case, I wouldn't think it's " 'br)
                (str "strange！" 'br)
                (str "　　　　　　　　No, Jonathan, hold back. We don't have to interrogate " 'br)
                (str "that man right now." 'br)
                (proc 0)
                ...
                (str "　　　　　　　　More importantly, isn't it smarter to let them think we ")
                (str "don't know anything？" 'br))
               (/
                (str "Come to think of it......" 'br)
                (str "When I came here before, there was a crest above the entrance of ")
                (str "the Church." 'br)
                (proc 0)
                (proc 3)
                (proc 9)
                ...
                (exec-mem 256 "P 5 28 48")
                (str "[Jonathan] " 'br)
                (str "Professor,　don't　you　recognize　the　crest　above　that　entrance？" 'br)
                (proc 0)
                ...
                (proc 0)
                (str "[Gardner] Ah......" 'br)
                (str "　　　　　　　　Hold on a second, I feel like I've seen this somewhere " 'br)
                (str "before..." 'br)
                (proc 0)
                (str "[Gardner] That was......")
                (proc 0)
                (str "[Gardner] Jonathan, that's the mark of the Freemason！" 'br)
                (str "　　　　　　　　You saw it too, right? The same crest was on Thomas's " 'br)
                (str "Ring." 'br)
                (proc 0)
                (str "[Jonathan] I see, so that's what it was." 'br)
                (str "　　　　　　　　I've been weirdly curious about it since I saw it " 'br)
                (str "before." 'br)
                (proc 0)
                (str "[Gardner] But why the hell is that emblem hanging in the Church, ")
                (str "anyway?" 'br)
                (proc 0)
                (str "[Jonathan] Is there some kind of connection between this church, ")
                (str "that black priest named Nai, and Thomas？" 'br)
                (proc 0)
                (str "[Gardner] Even if that were true, I wouldn’t find it strange！" 'br)
                (str "　　　　　　　　No, Jonasan, hold it. You don't have to press that guy " 'br)
                (str "right now." 'br)
                (proc 0)
                (str "[Jonathan] Why is that？" 'br)
                (str "　　　　　　　　This is your chance to find out who Thomas really is.")
                ...
                (exec-mem 2928 12 16 67 287 7 1)
                (proc 1)
                (str "[Gardner] I can't believe that guy would actually spill the " 'br)
                (str "truth." 'br)
                (str "　　　　　　　　But wouldn't it be smarter to let them think we don't " 'br)
                (str "know anything？" 'br))))
             (proc 0)
             (nop@)
             (set-reg 440 #t)))))
      (/
       (if (</>
            ...
            (//
             ...
             (str "　　　　　　　　If you stick with us, you won't have a thing to worry " 'br)
             (str "about." 'br)
             (proc 0)
             (str "[Cordelia] Yeah...... It's strange, even to me." 'br)
             (str "　　　　　　　　It's not my first time coming here, and usually it's " 'br)
             (str "nothing at all　　　　　　　　so yeah." 'br)
             (proc 0)
             (str "[Jonathan] Maybe you had a bad experience before, and it's " 'br)
             (str "making you feel afraid without even realizing it." 'br)
             (proc 0)
