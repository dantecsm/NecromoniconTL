 ...
 (seg (? (= 997 #t) (= 998 #t) (= 999 #t))
   ...
   (if (</>
        (//
         ...
         (str "I thought she might have come to Fish Scale Inn to check on me because I was late, but if that's the case, she might be up in my room.")
         (proc 0))
        (//
         (? (= 97 #t))
         (nop@)
         ...
         (str "Now that the sun has completely set, the only thing lighting up the area is the faint glow from the street lamps.")
         (proc 0)
         (str "Rain clouds that warn of an approaching storm still linger overhead, but maybe because of those clouds, the air out here-despite the strong wind and being away from the sea-doesn't feel cold.")
         (proc 0))
        (//
         (? (= 503 #t))
         (nop@)
         ...
         (proc 0)
         (str "「Jonathan」 Yeah, I just had a little chat with Mrs. Hudson.　　　　　　　　I apologized for missing breakfast.")
         (proc 0)
         (str "「Cordelia」 I see......")
         (proc 0)
         (nop@)
        ...
        (//
         ...
         (proc 1)
         (str "I'm in front of Fish Scale Inn." 'br)
         (str "Since I haven't been back since last night, it feels like it's been ages since I returned.")
         (proc 0)
         (str "According to Gardner, Mrs. Hudson seems to be upset about me and Cordelia, so maybe it’s better if I apologize to her once.")
         (proc 0)
         (nop@)
         (set-reg 502 #t))))
   (proc 3)
      ...
      (/
       (if (</>
            (//
             (? (= 178 #t))
             (nop@)
             (str "The reason people don’t come to the Fish Scale Inn might actually be because of us.")
             (proc 0)
             (str "The villagers who dislike outsiders like us would never do something like eat in front of us.")
             (proc 0))
            (//
             (str "It’s the only inn in the village, the Fish Scale Inn." 'br)
             (str "The old building tells the story of having continued business for generations without anyone ever making renovations.")
             (proc 0)
             (str "It must be tough running an inn in a village with basically no tourists, but I really hope it doesn’t go out of business at least while we’re staying here.")
             (proc 0)
             (str "Of course, it all depends on Mrs. Hudson, but I hope she doesn't suddenly disappear like her husband did.")
             (proc 0)
             (nop@)
             (set-reg 178 #t)))))
      (/
       (if (</>
            (//
             (? (= 179 #t))
             (nop@)
             (str "Now I’m starting to worry about whether the door is actually unlocked." 'br)
             (str "All I can do is hope she doesn’t lock me out.")
             (proc 0))
            (//
             (str "From the silent building, I can’t even sense if anyone’s inside. Honestly, I’m not even sure if anyone really lives here.")
             (proc 0)
             (str "I can't imagine Mrs. Hudson would do something like locking out her guests, but considering I've been getting on her nerves lately, maybe she'd do something like that to me.")
             (proc 0)
             (str "It almost feels like she's become Cordelia's mother, but since Cordelia doesn't have parents, maybe she just can't leave her alone, like a daughter, to Mrs. Hudson.")
             (proc 0)
             (nop@)
             (set-reg 179 #t)))))
      (/
       (if (</>
            (//
             ...
             (proc 0)
             (str "She's bravely following along with us, but maybe it'd be better to send her back to Gilman House if she's like this.")
             (proc 0))
            (//
             (? (= 180 #t))
             (nop@)
             (str "She really doesn't look like she wants to be in front of Fish Scale Inn." 'br)
             (str "She's probably worried about the talk of Mrs. Hudson being mad at me.")
             (proc 0))
            (//
             (str "When she sees me show up in front of Fish Scale Inn, she gives me a weird look." 'br)
             (str "Maybe she's thinking about what Gardner said, about Mrs. Hudson being angry at me.")
             (proc 0)
             (str "It was Cordelia's idea in the first place for me to stay at Gilman House.")
             (proc 0)
             (nop@)
             (set-reg 180 #t)))))
      (/ (nop@))
      ...
      (/
       (if (</>
            ...
            (//
             ...
             (str "　　　　　　　　For a young girl to be meeting a guy every night, that's something the madam just can't forgive.")
             (proc 0)
             (str "「Cordelia」 Why？" 'br)
