        ...
        (branch-reg
         ...
         (</>
          (/
           ...
           (str "Madam, left alone in the shop, looks at me with a face of " 'br)
           (str "relief, like she's seen a savior." 'br)
           (proc 0)
          ...
          (/
           ...
           (proc 0)
           (str "Mary's face is pale, and the smile floating at her lips is " 'br)
           (str "somehow unnatural, like her mind is confused." 'br)
           (proc 0)
     ...
     (/
      (branch-index
       (</>
        ...
        (/
         (str "Mixed in with the strong perfume that fills the room, there's " 'br)
         (str "also a nasty stench that makes you feel sick." 'br)
         (proc 0)
         (str "Every time I go out to cover incidents in the streets of London, ")
         (str "there’s that familiar smell... This has gotta be the stench of " 'br)
         (str "blood, no doubt about it." 'br))))
      (proc 0))
     (/
      (branch-index
       (</>
        (/
         ...
         (str "Maybe the fact that they pay attention to such little details is ")
         (str "proof that they're serious about their business." 'br)
         (proc 0)
         (str "It probably isn't easy to set up a store this big in Arkham, so ")
         (str "maybe the lady owner here is actually pretty sharp." 'br))
        (/
         (str "Compared to places like Fish Scale Inn and Gilman House, they " 'br)
         (str "seem to be more proactive about investing in their facilities." 'br)
            ...
            (branch-reg
             ...
             (</>
              (/
               ...
               (proc 0)
               (str "[Madam] As soon as they came in, they said stuff like 'today's " 'br)
               (str "our last time'... I just thought, oh, I guess these guys will be ")
               (str "out fishing for a while starting tomorrow." 'br)
               (proc 0)
               (str "[Madam] Not a lot of them come back to the port for about a week ")
               (str "after they take their boat out." 'br)
               (proc 0)
               (str "[Madam] But still...")
               (proc 0)
               ...
               (str "　　　　　　　　Those fishermen...")
               (proc 0)
               (str "[Madam] I woke up in the middle of the night to Sue and Mabel's ")
               (str "screams." 'br)
               (str "　　　　　　I wondered what the hell was going on, and peeked into the ")
               (str "room..." 'br)
               (proc 0)
               ...
               (str "　　　　　　Please, just let me forget everything for just a little " 'br)
               (str "while！" 'br)
               (proc 0)
               (str "[Jonathan] What are you even saying at a time like this.")
               (proc 0)
               (str "[Madam] I'm about to go insane！" 'br)
               (str "　　　　　　What the hell was that, this has to be a dream, yeah, " 'br)
               (str "that's got to be it..." 'br)
               (proc 0)
