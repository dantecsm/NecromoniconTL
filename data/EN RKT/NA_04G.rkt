 ...
 (seg (? (= 997 #t) (= 998 #f))
   ...
   (if (</>
        (//
         ...
         (proc 0)
         (str "Well, with that body, I bet he's way more energetic than me... He's probably planning to stay all night.")
         (proc 0))
        (//
         (? (= 117 #t))
         (nop@)
         ...
         (proc 0)
         (str "「Jonathan」 You can let your imagination run wild if you want, but Hudson-san is a proper lady, you know.")
         (proc 0)
         ...
         (str "　　　　　　We finally get to have some fun, but the one thing we need most is totally useless... that's just too much.")
         (proc 0)
         (proc 3)
         (proc 6)
        ...
        (//
         ...
         (str "　　　　　　I gotta admit, I was pretty shocked when you collapsed at the monastery.")
         (proc 0)
         (str "「Jonathan」 君と教授が運んでくれたのかい？" 'br)
         (str "　　　　　　　　I　really　caused　you　a　lot　of　trouble,　sorry.")
         (proc 0)
         (str "「Thomas」 Nah, don’t worry about it." 'br)
         (str "　　　　　　More importantly, I'm glad I made it in time. I was just about to head out.")
         (proc 0)
         ...
         (str "　　　　　　If you take it too slow, the sun'll come up before you know it.")
         (proc 0)
         (branch-reg
          115
          (</>
           (/
            ...
            (str "　　　　　　　　If I don't hurry up and get this over with, my body won't last.")
            (proc 0)
            (str "「Thomas」 Well, do you really think it'll go that smoothly？" 'br)
            (str "　　　　　　My gut tells me, you're the type to get hooked pretty hard.")
            (proc 0)
            ...
            (mes-jump "MES¥NM_01A.MES"))
           (/
            (str "「Jonathan」 Wait a sec, I've got an appointment to meet Mrs. Hudson.")
            (proc 0)
            (str "「Thomas」 You and the lady？" 'br)
            (str "　　　　　　Hey,　hey……　You’re　pretty　good,　aren’t　you?")
            (proc 0)
            (str "「Jonathan」 That's not it！" 'br)
            (str "　　　　　　　　The professor mentioned it this morning, right? That his wife was pissed off at me.")
            (proc 0)
            (str "「Thomas」 Ah, that, huh......")
            (proc 0)
            (str "「Jonathan」 It'll be done soon, so just wait for me.")
            (proc 0)
            (str "「Thomas」 No need to rush. If you think about why the lady’s getting mad, it’s not like there’s zero chance for you, right?")
            (proc 0)
            (str "「Jonathan」 What's your reason, huh？" 'br)
            (str "　　　　　　　　The lady is worried about Cordelia. She thinks it'd be a huge problem if people started saying her daughter's a slacker.")
            (proc 0)
            ...
            (proc 0)
            (str "「Thomas」 Wouldn't be strange if you got a bit of a sense of adventure." 'br)
      ...
      (/
       (if (</>
            (//
             (? (= 337 #t))
             (nop@)
             (str "This room is on the shady backside, so it's weirdly damp and honestly not all that comfortable.")
             (proc 0)
             (str "Considering the awkward relationship between Thomas and Mrs. Hudson, maybe she gave Thomas this lousy room on purpose.")
             (proc 0)
             (str "Mrs. Hudson, who's always gentle and doesn't have a trace of slyness, just doesn't seem like the type to do something like that, but I honestly can't think of a reason why she would've gone out of her way to stick Thomas, who'd been staying here at the Fish Scale Inn even before I decided to, in such a lousy room.")
             (proc 0))
            (//
             (str "Thomas's room is just as tidy as he claims to like things clean, everything is neatly organized.")
             (proc 0)
             (str "そればかりか、この部屋にはトマスが滞在しているという事を伝えるような荷物や衣服の類が一切存在しない。")
             (proc 0)
             (str "Is this how his secret society does things?" 'br)
             (str "Even if I try to snoop around the room while Thomas isn't here, there's no way I'd find anything like this.")
             (proc 0)
             (str "Maybe they keep things light around them so they can disappear at any time.")
             (proc 0)
             (nop@)
             (set-reg 337 #t)))))
      (/ (nop@))
      ...
      (/
       (if (</>
            ...
            (//
             ...
             (proc 0)
             (str "The sheet is just as Mrs. Hudson made the bed, neatly arranged without a single wrinkle.")
             (proc 0)
             (str "He's probably planning to spend the night in the prostitute's room again until morning." 'br)
             (str "No matter how nicely Mrs. Hudson makes the bed, it doesn't mean a thing.")
             (proc 0)
             (nop@)
             (set-reg 338 #t)))))
      (/
       (if (</>
            (//
             ...
             (proc 0))
            (//
             (str "It's night now so I can't tell, but since it's at the back of the Fish Scale Inn that's in the shade even during the day, sunlight pretty much never comes in through this window.")
             (proc 0)
             (str "Doesn't seem like it would make much difference even if the curtain was open." 'br)
      ...
      (/
       (if (</>
            (//
             ...
             (str "It might've been here as equipment ever since the Fish Scale Inn first opened.")
             (proc 0))
            (//
             (str "私の部屋にある物と大した変わりはない。" 'br)
             (str "It's too high to eat at, and it seems too tall to use as a writing desk.")
             (proc 0)
             (str "Well, Thomas isn't the type to write things down eagerly, and he probably wouldn't want to eat alone either.")
             (proc 0)
