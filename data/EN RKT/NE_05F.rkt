 ...
 (seg (? (= 997 #t) (= 998 #f))
   ...
   (if (</>
        (//
         ...
         (str "If the Necronomicon was mixed in with books like this, you’d know it at a glance.")
         (proc 0))
        (//
         (str "There are only brand-new books on this bookshelf." 'br)
         (str "If the Necronomicon was mixed in among books like these, you'd recognize it in an instant.")
         (proc 0)
    ...
    (branch-var
     ...
     (</>
      ...
      (/
       ...
       (proc 0)
       (str "The previous owner, whether it was a he or a she, probably read this book over and over.")
       (proc 0))
      (/
       (str "Looks like one of those typical complete works of Shakespeare." 'br)
       (str "It's not like it's some especially expensive binding, and since it's just one book out of a whole collection, it doesn't seem to have any value at all.")
       (proc 0))
      (/
       (str "It's John Collins' theology book." 'br)
       (str "Didn't expect you to have a book by some not-so-famous British theologian." 'br)
       ...
       (str "It's not like I have any intention of killing myself or anything.")
       (proc 0))
      (/
       (str "『Love and Law』" 'br)
       (str "Maria Edgeworth")
      ...
      (/
       ...
       (str "I read this back when I was still a student, if I remember right.")
       (proc 0))
      (/
       (str "『Oedipus Rex』" 'br)
       (str "Sophocles")
       (proc 0)
       (str "『We saw a swaying noose, and the figure of a woman who had hanged herself.』" 'br)
